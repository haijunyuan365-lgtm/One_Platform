...
const projects: ProjectCard[] = [
  { id: 1, name: '公司统一门户', shortName: '统一门户', logo: buildAsset('门户', '#2563eb'), category: '内部系统', tags: ['正式', '内网', 'SSO'], description: '公司内部应用入口，统一展示项目地址、账号资料和运行状态。', maintainer: '管理员', status: '可用', lastCheckTime: '2026-06-05 09:10:00', responseTime: 126 },
  { id: 2, name: '客户项目交付看板', shortName: '交付看板', logo: buildAsset('交付', '#059669'), category: '客户项目', tags: ['正式', '外网'], description: '展示客户项目里程碑、风险、问题和验收资料的交付看板。', maintainer: '王五', status: '维护中', lastCheckTime: '2026-06-05 08:50:00', responseTime: 243, abnormalReason: '周五例行发布窗口' },
  { id: 3, name: 'AI 原型生成平台', shortName: 'AI 原型', logo: buildAsset('AI', '#7c3aed'), category: 'AI工具', tags: ['测试', '内网', 'AI'], description: '为产品经理提供需求文档、原型页面和测试用例的智能生成工具。', maintainer: '赵六', status: '可用', lastCheckTime: '2026-06-05 09:12:00', responseTime: 98 },
  { id: 4, name: '经营数据分析平台', shortName: '数据分析', logo: buildAsset('BI', '#dc2626'), category: '数据平台', tags: ['正式', '内网', '报表'], description: '集中展示销售、交付、财务和运维指标，支持经营例会复盘。', maintainer: '周八', status: '异常', lastCheckTime: '2026-06-05 08:58:00', responseTime: 0, abnormalReason: 'HTTP 502' },
  { id: 5, name: '运维监控中心', shortName: '监控中心', logo: buildAsset('Ops', '#ea580c'), category: '运维服务', tags: ['正式', '内网', '监控'], description: '统一查看服务健康度、告警、CI/CD 和服务器资源。', maintainer: '李四', status: '可用', lastCheckTime: '2026-06-05 09:08:00', responseTime: 164 },
]
...
const qrcodes: Record<number, ProjectQrcode[]> = {
  ...
  2: [{ id: 2, name: '客户验收入口', image: buildAsset('验收', '#047857'), audience: '项目干系人', description: '客户项目验收用。' }],
  3: [{ id: 3, name: 'AI工具入口', image: buildAsset('AI', '#6d28d9'), audience: '产品与研发', description: '扫码进入 AI 原型工具。' }],
...
function instruction(project: ProjectCard): ProjectInstruction {
  return {
    ...
    notes: `${project.name} 的资料由 ${project.maintainer} 维护，若无法访问请优先联系维护人。`,
